...
public class Transaksi {
    ...
    public void ProsesTransaksi(Member member, Barang barang, Transaksi transaksi, int Member){
        ...
        System.out.println("Transaksi belanja Member "+ member.getNama(idMember)+" Sebagai berikut: ");
